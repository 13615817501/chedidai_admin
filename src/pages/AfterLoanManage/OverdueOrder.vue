...
export default {
    ...
    methods: {
        ...
        downLoad(){
            window.open(`${this.host}/file/download?api=gate.order.excle.exportOverdueListExcleService&v=1.0&ttid=1002&did=1&ts=1480929340486&lng=39.98871&lat=116.43234&mat=${this.mat}&sign=inm&data=${encodeURIComponent(JSON.stringify(util.searchList(this.search,'timeInterval')))}`);
        }
    } 
}
</script>
